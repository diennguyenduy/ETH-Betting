App = {
  ...
  init: function() {
    if (typeof web3 !== 'undefined') {
      ...
      App.web3Provider = new Web3.providers.HttpProvider('http://localhost:3002');
    }
  ...
  initContract: function() {
    var bettingContract = web3.eth.contract(
      [
        {
          "constant": false,
          "inputs": [
    ...
    App.contract = bettingContract.at("0xcd5f93b7e873427ab3e97d200ef189695b625495");
